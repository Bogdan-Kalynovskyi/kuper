...
EOF;
        ...
        <br/>
        <img src="images/plus.gif" title="добавить" alt="добавить" onclick="add()" style="margin-top:-10px;margin-left:40px; cursor:pointer"> &nbsp; ¬ св€зи с глюками браузеров
        рекомендуетс€ сначала «ј√–”«»“№ картинки, а затем ѕ≈–≈ћ≈ўј“№ их вверх-вниз
        <br/>
        <br/>
