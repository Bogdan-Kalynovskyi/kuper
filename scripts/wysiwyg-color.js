...
function WYSIWYG_Color() {
    ...
    // colors
    var COLORS = new Array("#000000", "#993300", "#333300", "#003300", "#003366", "#000080", "#333399", "#333333", "#800000", "#FF6600", "#808000", "#008000", "#008080", "#0000FF", "#666699", "#808080", "#FF0000", "#FF9900", "#99CC00", "#339966", "#33CCCC", "#3366FF", "#800080", "#999999", "#FF00FF", "#FFCC00", "#FFFF00", "#00FF00", "#00CCFF", "#993366", "#C0C0C0", "#FF99CC", "#FFCC99", "#FFFF99", "#CCFFCC", "#CCFFFF", "#99CCFF", "#666699", "#777777", "#999999", "#EEEEEE", "#FFFFFF");
    ...
    this.choose = function (element) {
        ...
        if (x + div.offsetWidth > winsize.width) {
            x = winsize.width - div.offsetWidth - 5;
        }
        if (y + div.offsetHeight > winsize.height) {
            y = winsize.height - div.offsetHeight - 5;
        }
        div.style.left = x + "px";
        div.style.top = y + "px";
