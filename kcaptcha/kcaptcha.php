    ...
    function KCAPTCHA() {
        ...
        do {
            ...
            while (true) {
                ...
                if (!preg_match('/cp|cb|ck|ch|c6|c9|c3|cq|cd|ce|cg|cu|cc|cm|cn|mm|mn|nm|nn|nw|wn|wm|mw|ww|wv|vw|db|qp|qb|dp|dh|qh|dn|qn|dm|qm|dk|qk|z7|4z|d5|c4|vv|cl/', $this->keystring)) {
                    break;
                } //|rn|rm|rw|rp|rh|ru|rb|rr|co|do|cl|lb|al|ol
            }
