		...
		<tr>
			<td>
				  <?php
					...
					if($dirok) {
					?>
					<a href="<?php echo $_SERVER['SCRIPT_NAME'].'?dir='.myurlencode($dotdotdir); ?>"><img src="images/dirup.png" alt="Folder" border="0" /> <strong>..</strong></a><br>
					<?php
						if($class=='b') $class='w';
						else $class = 'b';
					}
					...
					?>
					<a href="<?php echo $_SERVER['SCRIPT_NAME'].'?dir='.myurlencode($leadon.$dirs[$i]); ?>"><img src="images/folder.png" alt="<?php echo $dir; ?>" border="0" /> <strong><?php echo $dir; ?></strong></a><br>
					<?php
						if($class=='b') $class='w';
						else $class = 'b';	
					}
					...
					for($i=0;$i<$arsize;$i++) {
						...
						if(!in_array($ext, $supportedextentions)) {   //changed
