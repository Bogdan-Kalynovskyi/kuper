...
if(empty($f2)) $f2 = upload_file(true);
...
if(empty($_POST['max_x']))$_POST['max_x']=100;
if(empty($_POST['max_y']))$_POST['max_y']=100;
...
function check() {
  ...
  if(ext != 'jpg' && ext != 'jpeg' && ext != 'gif' && ext != 'png') {
    alert('You selected a .'+ext+
          ' file; That is a wrong extension!');
    return false; }
  return true; 
}
...
function loadImage() {
	...
	for(var i = 0;i < img.attributes.length;i++) {
		...
		if(attr && value && value != "null") {
			switch(attr) {
				case "src": 
					var val1 = /<?php echo str_replace("/","\\/",$imagebaseurl); ?>/;
					
					if(WYSIWYG_Core.isMSIE) value = WYSIWYG.stripURLPath(n, value, false);
					if(value.search(val1)==0) value = value.replace(val1, "");/* " */
...
function clear_f1() {
	...
	document.getElementById("test").innerHTML=
		'<input type="file" name="file" size="37" style="font-size: 12px; width: 100%;" onchange="clear_f2();" onkeydown="clear_f2();" >';
}
...
<table width="405" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
	...
	?>
		<tr>
			...
			<td style="padding-top: 7px;padding-bottom: 0px;width:300px;"><span id="test"><input type="file" name="file" size="37" style="font-size: 12px; width: 100%;" onchange="clear_f2()" onkeydown="clear_f2();" ></span></td>
		</tr>
		<tr>
	...
	<tr>
		...
		<td style="padding-bottom: 6px; padding-top: 0px;" width="300"><input type="text" name="src" id="src" value="<?php echo @$_POST['src'];?>" onchange="clear_f1();"onkeyup="clear_f1();x1()" style="font-size: 12px; width: 100%;"></td>
	</tr>
	<tr>
		<td style="padding-bottom: 4px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 12px;">Коментар:</td>
		<td style="padding-bottom: 4px; padding-top: 0px;"><input type="text" name="alt" id="alt" value="<?php echo @$_POST['alt'];?>"  style="font-size: 12px; width: 100%;"></td>
	</tr>
	<tr>
...
<table width="405" border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;padding-top:20px; ">
...
<tr>
  ...
  <td style="width:60px;padding-bottom: 2px; padding-top: 0px;"><input type="text" name="width" id="width" value="<?php echo $orig_x; ?>"  style="font-size: 11px; width: 100%;color:#777777; background-color: #eeeeee;"maxlength="4"></td>
 </tr>
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 12px;">Height:&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td style="padding-bottom: 2px; padding-top: 0px;"><input type="text" name="height" id="height" value="<?php echo $orig_y; ?>"  style="font-size: 11px; width: 100%;color:#777777; background-color: #eeeeee;"maxlength="4"></td>
 </tr>
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 12px;">Border:</td>
	<td style="padding-bottom: 2px; padding-top: 0px;"><input type="text" name="border" id="border" value="<?php echo $_POST['border'];?>"  style="font-size: 11px; width: 100%;color:#777777; background-color: #eeeeee;" maxlength="4"></td>
 </tr>
</table>	
...
<table width="220" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;margin-top:10px">
<tr>
  <td style="width: 135px;padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 12px;" width="100">Alignment:</td>
	<td style="width: 85px;padding-bottom: 2px; padding-top: 0px;">
	<select name="align" id="align" style="font-family: arial, verdana, helvetica; font-size: 12px; width: 100%;color:#777777; background-color: #eeeeee;">
 ...
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 12px;">Horizontal Space:</td>
	<td style="padding-bottom: 2px; padding-top: 0px;"><input type="text" name="hspace" id="hspace" value="<?php echo $_POST['hspace'];?>"  style="font-size: 11px; width: 100%;color:#777777; background-color: #eeeeee;"></td>
 </tr>
 <tr>
  <td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 12px;">Vertical Space:</td>
	<td style="padding-bottom: 2px; padding-top: 0px;"><input type="text" name="vspace" id="vspace" value="<?php echo $_POST['vspace'];?>"  style="font-size: 11px; width: 100%;color:#777777; background-color: #eeeeee;"></td>
 </tr>
</table>	
