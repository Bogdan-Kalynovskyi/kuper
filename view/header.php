...
<body><?php 
				if(LEVEL)
				{
					if(LEVEL < 3)echo'<h3 class="toph3" style="background:#99F">User area&nbsp; - &nbsp;<a href="user_home.php" title="Go to profile...">'.$USER['name'].'</a></h3>';
					else echo '<h3 class="toph3" style="background:orange">Admin area <!-- - find more! --></h3>';
				}
