function popWin(url) {
    window.open(url, 'popup', 'toolbar=No,menubar=No,left=200,top=200,width=480,resizable=yes,scrollbars=yes,status=No,location=No,height=300');
}
function popWin1(url) {
    window.open(url, 'Statistics', 'toolbar=No,menubar=No,left=10,top=210,width=910,resizable=no,scrollbars=no,status=No,location=No,height=320');
}

function bmc_go_page(page) {
    document.getElementById('nname').value = page;
    document.pager.submit();
}

function bmc_per_page() {
    document.pager.pp.value = document.getElementById('pname').value;
    document.pager.submit();
}
//***********************************************************************************************************************************/
