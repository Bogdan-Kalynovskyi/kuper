...
<div id="overall">
	...
	<input id="write" type="submit"  value="      �������� �����       " tabindex="4" onclick="document.location='#new_post';document.getElementsByName('name')[0].focus();" />
...
?>
	...
	<label>���� &nbsp;<span>(URL ��� ����)</span> <a href="#" id="aaa" title="������ �����" onclick="clrnpt1('icon');return false">������</a>
	...
	<br/>
	<label>
		<input type="submit" style="letter-spacing:1px;padding-left:1px" value="      <?php echo (!isset($_GET['edit'])?'��������':'��������'); ?> �����      " tabindex="100" />
	</label>
	<br/>
