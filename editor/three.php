...
foreach($BLOGS as $key=>$val){
		...
		<div class="baba" id="_$k">
			...
			<a href="index.php?page=$key" target="_blank" class="_eye_" title="просмотреть"><img src="img/eye_small.gif" alt="&bull;"/></a> &nbsp;
			...
			<input type="text" name="v[$key]" value="$val" id="v$k" style="width:301px" /> &nbsp;&nbsp;
				...
				<p><img src="{$FONS[$key]}" alt="фон" id="_f$k" /> &nbsp;
					...
					<b id="x$k">
					URL<input type="text" name="f[$key]" id="f$k" value="{$f}" /> или файл<input type="file" id="__f$k" name="f$key" />&nbsp; <a onclick="clrnpt('f$k');return false">”брать</a>
					</b>
				</p>			
...
<br/>
	<img src="images/plus.gif" title="добавить" alt="добавить" onclick="add()" style="margin-top:-10px;margin-left:40px; cursor:pointer" /> &nbsp; ¬ св€зи с глюками браузеров рекомендуетс€ сначала «ј√–”«»“№ картинки, а затем ѕ≈–≈ћ≈ўј“№ их вверх-вниз
	<br/>
	<br/>
	
	<input type="submit" value="      —охранить      " style="margin-left:30px" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
	<input type="button" value="      ќтмена      " onclick="document.location='user.php'" />
