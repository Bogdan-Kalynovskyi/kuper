...
require  dirname(__FILE__)."/../vars/config.php";

//==============================================================================
if(empty($my_db)) die('Site is not properly installed! <a href="install.php">Click here to install</a>');
/*if( file_exists("$root/install.php")) {OK а також всяк1 1нш1 блять зайобуюч1 перев1рки.
	краще контролювати сервак н1ж контролювати скрипт
...
//типа magic quotes register globals
}*/
//==============================================================================
...
if(get_magic_quotes_gpc()){//думаєм про вс1 забаганкт//tut mae butu we wos
	$_GET = stripslashes_deep($_GET);
	$_POST = stripslashes_deep($_POST);
	$_COOKIE = stripslashes_deep($_COOKIE);
}//я не пацае якщо не завипишу тут весь список ексепшеныв
...
/*	$USER = null;
	...
	if(defined('REQUIRED') && REQUIRED > LEVEL){
		...
		if($USER && !is_array($USER))//cant login//разрыв секьюрити
		...
		//ghjпроизошел апаратный сбой или ибрыв cookies
