<?php
	...
	$title = array('Çàãîëîâîê ñàéòà','Ñëîâà äëÿ ïîèñêîâèêîâ','Îïèñàíèå ñàéòà','Email', 'Òåëåôîí', 'ÂÊîíòàêòå', 'LiveJournal', 'Eùå êîíòàêòû &nbsp;<small><small>(Íåîáÿçàòåëüíî. &nbsp;Ðàçðåøåí êîä HTML)</small></small> ', 'Ôîí ïî óìîë÷àíèþ &nbsp;<small><small>(Ïóñòî äëÿ "ìàòîâîãî ñòåêëà". &nbsp;Ïðîáåë - âîîáùå áåç ôîíà)</small></small>', 'Âîçìîæíîñòü ðåäàêòèðîâàíèÿ ïðè ïðîñìîòðå ñòðàíèöû &nbsp;<small><small>(Òîëüêî åñëè çàëîãèðîâàëñÿ)</small></small> ');
...
<h2> Äîïîëíèòåëüíàÿ èíôîðìàöèÿ... </h2>
...
EOF;
			...
			<label>{$title[$i]}<br> 
				...
				èëè ôàéë <input type="file" name="$n" id="__$n"> &nbsp; <a href="#" onclick="clrnpt('$n');return false"><small>Óáðàòü</small></a>
			</label><br/><br/>
EOF;
			break;
		}
...
?>
<br/>
	<input type="submit" value="      Ñîõðàíèòü      " style="color:#222">&nbsp; &nbsp; &nbsp;
