...
<span style="font-family: arial, verdana, helvetica; font-size: 12px; font-weight: bold;" id="ccc">Посилання на файл для скачування:</span>
<table width="380" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
	...
	?>
		<tr>
			...
			<td style="padding-top: 0px;padding-bottom: 0px;width:300px;"><span id="test"><input type="file" name="file" size="30" style="font-size: 12px; width: 100%;" accept="image/gif, image/jpeg, image/png, image/bmp" onchange="clear_f2();" onkeydown="clear_f2();" ></span></td>
		</tr>
		<tr>
	...
	<tr>
		...
		<td style="padding-bottom: 2px; padding-top: 0px;" width="300"><input type="text" name="src" id="src" value="<?php echo $_POST['src'];?>" onchange="clear_f1();"onkeydown="clear_f1();" style="font-size: 12px; width: 100%;"></td>
	</tr>

		<tr>
			<td style="font-size: 9px;">&nbsp;</td><td></td>
		</tr>
	
	<tr>
				<td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 12px;">Підказка:</td>
		<td>
			<input type="text" name="title" id="title" value="<?php echo $_POST['title'];?>" style="font-size: 11px; width: 100%;  color:#777777; background-color: #eeeeee;">
		</td>	
	</tr>
...
<td style="vertical-align: top;width: 200px; padding-left: 5px;">
	...
	<iframe id="chooser" frameborder="0" style="height:154px;width: 200px;border: 2px solid #FFFFFF; padding: 5px;" src="select_file.php?dir=<?php echo $leadon; ?>"></iframe>
</td>
</tr>
</form>
</table>
