...
//			var u=$("slideleft"),	r=$("slideright");
        ...
        this.ss.onmouseout = /*u.onmouseout=r.onmouseout=u.onmouseup=r.onmouseup=*/function () {
            TINY.scroll.cl(self.p)
        };
...
////////////////////
        ...
        for (var i = 0; i < this.l; i++) {
            ...
            g.onmouseover = function () {
                TINY.alpha.set(this, 100, 5)
            };
            g.onmouseout = function () {
                if (!this.style.borderColor) {
                    TINY.alpha.set(this, self.thumbOpacity, 7)
                }
            };//DODO JSPERF VS new Func
    ...
    le: function (s, c) {
        ...
        if (this.a[s].l) {
            this.q.onmouseover = function () {
                TINY.alpha.set(this, slideshow.navHover, 4);
                zoomPreload(slideshow.a[s].l);
            };
            this.q.onmouseout = function () {
                TINY.alpha.set(this, 0, 7)
            };
            this.q.onclick = function (event) {
                slideshow.zoomClick1(m, s, event)
            };
