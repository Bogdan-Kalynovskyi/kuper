...
if (isset($_GET['loop']) && $_GET['loop'] > 3) {
    die ('Cookies turned off or not working in your browser');
}
...
if (noempty($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'], $MY_URL) === 0 && basename($_SERVER['HTTP_REFERER']) != 'install.php' && basename($_SERVER['HTTP_REFERER']) != __FILE__ && strpos($_SERVER['HTTP_REFERER'], '_account_=') === false) {
...
//START/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if (isempty($_POST['wp_user_login']) || isempty($_POST['wp_user_pass']) || isempty($_POST['wp_' . LOGIN_HASH]) || //		(sha1(session_id()) != $_POST['wp_'.LOGIN_HASH]) ||
    bad_cap(false, true)
) {
