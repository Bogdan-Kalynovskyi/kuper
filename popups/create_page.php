...
<div align="right" style="padding-top: 5px;"><input type="submit" value="      ОК      " onclick="insertHyperLink();" style="font-size: 12px;" >&nbsp;<input type="button" value="  Cancel  " onclick="window.close();" style="font-size: 12px;" ></div>
